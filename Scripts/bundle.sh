#!/bin/bash
#
# Packt openzonr in ein signiertes App-Bundle.
#
# Ohne das kommt man an die Bedienungshilfen nicht heran. Eine unsignierte
...
#
# Damit überlebt die Freigabe jeden Neubau. Ein Ad-hoc-Zertifikat genügt
# nicht — es hat keine solche Kette.
#
set -euo pipefail
